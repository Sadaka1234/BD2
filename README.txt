Realizamos las siguientes modificaciones:
	-Se cambiaron varios atributos y cardinalidades segun la presentación realizada en la parte 1 del trabajo.
	-Luego de cargar la base de datos dispuesta como dbtest.sql, se pueden realizar las acciones desde la pagina local "localhost"
	...
	- Caso1, caso2, caso3 y caso5 fueron realizados y funcionan bien.
